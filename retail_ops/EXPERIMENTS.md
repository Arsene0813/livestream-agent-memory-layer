...
| `search_entry_share_pct`                | Kept as a directional search-entry structure metric.                                     | Reading search-entry share together with search exposure, search rank, entry conversion, order conversion, activity, refund, invalid-order, store type, and region context.        |
