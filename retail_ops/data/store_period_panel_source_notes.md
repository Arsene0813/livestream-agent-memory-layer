...
The current panel contains Store B, Store C, Store D, and Store E for February, March, and April 2026. March rows are copied from the existing Demo 2 source table to avoid manual re-entry drift.

## Scope

| Item | Current value |
|---|---|
| Current panel stores | Store B, Store C, Store D, and Store E |
