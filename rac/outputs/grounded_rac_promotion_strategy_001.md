...
|---|---|---|---|---|---|---|
| activity_orders | retail_ops/data/DATA_DICTIONARY.md | default_evidence | keyword_matched | 116-118 | activity_orders | - explicit activity status, only if campaign-calendar or backend status evidence exists; - activity involvement, currently proxied by `activity_orders` and `activity_order_share_pct`; - activity intensity, currently proxied by `activity_cost`, `activity_cost_ratio_pct`, `merchant_subsidy_amount`, and `platform_subsi... |
| activity_cost | retail_ops/data/DATA_DICTIONARY.md | default_evidence | keyword_matched | 117-119 | activity_cost | - activity involvement, currently proxied by `activity_orders` and `activity_order_share_pct`; - activity intensity, currently proxied by `activity_cost`, `activity_cost_ratio_pct`, `merchant_subsidy_amount`, and `platform_subsidy_amount`. |
| merchant_subsidy | retail_ops/data/DATA_DICTIONARY.md | default_evidence | keyword_matched | 117-119 | merchant_subsidy | - activity involvement, currently proxied by `activity_orders` and `activity_order_share_pct`; - activity intensity, currently proxied by `activity_cost`, `activity_cost_ratio_pct`, `merchant_subsidy_amount`, and `platform_subsidy_amount`. |
| platform_subsidy | retail_ops/data/DATA_DICTIONARY.md | default_evidence | keyword_matched | 117-119 | platform_subsidy | - activity involvement, currently proxied by `activity_orders` and `activity_order_share_pct`; - activity intensity, currently proxied by `activity_cost`, `activity_cost_ratio_pct`, `merchant_subsidy_amount`, and `platform_subsidy_amount`. |
...
| payment_conversion | retail_ops/data/DATA_DICTIONARY.md | default_evidence | keyword_matched | 472-474 | 支付人数 | ### `payment_users` / 支付人数 |
