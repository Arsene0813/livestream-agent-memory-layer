...
def validate_state(case: dict[str, Any], state: dict[str, Any]) -> dict[str, Any]:
    ...
    if "Local Evidence Snippet" not in report:
        issues.append("report does not expose Local Evidence Snippet column")
...
def write_markdown_summary(results: list[dict[str, Any]], output_path: Path) -> None:
    ...
    lines.append("# Grounded RAC Quality Summary")
    lines.append("")
    lines.append("This file is generated by rac/scripts/validate_grounded_quality_gate.py.")
    lines.append("")
    ...
    lines.append("")
    lines.append("| Case | Passed | Factors | Hypotheses | Critic Findings | Grounded Rows | Keyword Matched | Boundary Matched | Fallback | Missing Sources |")
    lines.append("|---|---|---:|---:|---:|---:|---:|---:|---:|---:|")
